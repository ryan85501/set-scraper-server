...
def get_set_data():
    try:
        ...
        if set_result_element:
            set_index_div = set_result_element.find_next_sibling('div').find('div', class_='text-white')
        ...
        if value_element:
            value_span = value_element.find_next_sibling('div').find('div', class_='text-white')
